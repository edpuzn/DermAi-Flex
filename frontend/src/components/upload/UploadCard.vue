<template>
  ...
  >
    ...
    <div v-if="!hasFiles" 
         class="mt-auto flex flex-col items-center justify-center border-2 border-dashed rounded-xl p-6 transition-colors border-gray-300 group-hover:border-indigo-300 bg-gray-50"
    >
      <button 
        type="button"
